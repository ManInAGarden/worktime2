...
public class Project : WorkBase
{
	...
	private double CalcVerfuegbareStunden()
	{
		...
		ArrayList arrayLists = MainApp.workDayProjectLinkVerwo.Select(string.Concat("[projectOid]='", base.oid, "'"));
		foreach (WorkDayProjectLink workDayProjectLink in arrayLists)
		{
